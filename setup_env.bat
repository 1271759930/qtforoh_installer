...
SET QT_INSTALL_PATH=C:\Qt\Qt5.15.16-arm64-v8a
SET QT_ARCH=arm64-v8a
SET QT_BUILD_TYPE=debug
SET OHOS_TARGET_ARCH=arm64-v8a
SET PATH=C:\Program Files\Huawei\DevEco Studio\sdk\default\openharmony\native\llvm\bin;C:\code\qtforoh_installer\tools\perl\perl\bin;C:\code\qtforoh_installer\tools\llvm-mingw\bin;C:\Windows\System32;C:\Windows;C:\Users\lzh\AppData\Local\Programs\Python\Python314
